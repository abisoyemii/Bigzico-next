const CATEGORY_RULES = [
  ...
  },
  {
    slug: 'televisions',
    name: 'Televisions',
    keywords: ['television', 'tv', 'smart tv', 'led tv', 'oled tv', 'qled', 'qned', 'google tv'],
  },
  {
    slug: 'generators',
    name: 'Generators',
  ...
  },
  {
    ...
    keywords: ['mixer', 'blender', 'air fryer', 'kettle', 'toaster', 'cooker', 'oven', 'food processor', 'coffee maker', 'kitchen machine', 'rice cooker'],
  },
  {
    slug: 'smartphones',
    name: 'Smartphones',
    keywords: ['smartphone', 'iphone', 'android phone', 'mobile phone', 'galaxy'],
  },
  {
    slug: 'laptops',
    name: 'Laptops',
